...
CONTAINS
  ...
  SUBROUTINE xios(set_reduce_axis_to_scalar_attr)  &
    ( reduce_axis_to_scalar_id, local, operation )
    ...
    IMPLICIT NONE
      ...
      ( reduce_axis_to_scalar_hdl, local, operation )
  ...
  SUBROUTINE xios(set_reduce_axis_to_scalar_attr_hdl_)   &
    ( reduce_axis_to_scalar_hdl, local_, operation_ )
    ...
    IMPLICIT NONE
      ...
      IF (PRESENT(local_)) THEN
        ...
        CALL cxios_set_reduce_axis_to_scalar_local &
      (reduce_axis_to_scalar_hdl%daddr, local__tmp)
      ENDIF
  ...
  SUBROUTINE xios(get_reduce_axis_to_scalar_attr_hdl_)   &
    ...
    IMPLICIT NONE
      ...
      IF (PRESENT(local_)) THEN
        CALL cxios_get_reduce_axis_to_scalar_local &
      (reduce_axis_to_scalar_hdl%daddr, local__tmp)
  ...
  SUBROUTINE xios(is_defined_reduce_axis_to_scalar_attr_hdl_)   &
    ...
    IMPLICIT NONE
      ...
      IF (PRESENT(local_)) THEN
        local__tmp = cxios_is_defined_reduce_axis_to_scalar_local &
