...
MODULE reduce_axis_to_scalar_interface_attr
  ...
  INTERFACE
    ...
    SUBROUTINE cxios_set_reduce_axis_to_scalar_local(reduce_axis_to_scalar_hdl, local) BIND(C)
      USE ISO_C_BINDING
      INTEGER (kind = C_INTPTR_T), VALUE :: reduce_axis_to_scalar_hdl
      LOGICAL (KIND=C_BOOL)      , VALUE :: local
    END SUBROUTINE cxios_set_reduce_axis_to_scalar_local

    SUBROUTINE cxios_get_reduce_axis_to_scalar_local(reduce_axis_to_scalar_hdl, local) BIND(C)
      USE ISO_C_BINDING
      INTEGER (kind = C_INTPTR_T), VALUE :: reduce_axis_to_scalar_hdl
      LOGICAL (KIND=C_BOOL)             :: local
    END SUBROUTINE cxios_get_reduce_axis_to_scalar_local

    FUNCTION cxios_is_defined_reduce_axis_to_scalar_local(reduce_axis_to_scalar_hdl) BIND(C)
      USE ISO_C_BINDING
      LOGICAL(kind=C_BOOL) :: cxios_is_defined_reduce_axis_to_scalar_local
      INTEGER (kind = C_INTPTR_T), VALUE :: reduce_axis_to_scalar_hdl
    END FUNCTION cxios_is_defined_reduce_axis_to_scalar_local
