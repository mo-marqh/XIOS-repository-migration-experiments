...
CONTAINS
  ...
  SUBROUTINE xios(set_axisgroup_attr)  &
    ( axisgroup_id, axis_ref, axis_type, begin, bounds, bounds_name, chunking_weight, comment, convert_from_factor  &
    ...
    IMPLICIT NONE
      ...
      ( axisgroup_hdl, axis_ref, axis_type, begin, bounds, bounds_name, chunking_weight, comment, convert_from_factor  &
      , data_begin, data_index, data_n, dim_name, formula, formula_bounds, formula_term, formula_term_bounds  &
      , group_ref, index, label, long_name, mask, n, n_distributed_partition, n_glo, name, positive  &
      , prec, standard_name, unit, value )
  ...
  SUBROUTINE xios(set_axisgroup_attr_hdl_)   &
    ( axisgroup_hdl, axis_ref_, axis_type_, begin_, bounds_, bounds_name_, chunking_weight_, comment_  &
    , convert_from_factor_, data_begin_, data_index_, data_n_, dim_name_, formula_, formula_bounds_  &
    , formula_term_, formula_term_bounds_, group_ref_, index_, label_, long_name_, mask_, n_, n_distributed_partition_  &
    ...
    IMPLICIT NONE
      ...
      IF (PRESENT(chunking_weight_)) THEN
        CALL cxios_set_axisgroup_chunking_weight &
      (axisgroup_hdl%daddr, chunking_weight_)
      ENDIF
  ...
  SUBROUTINE xios(get_axisgroup_attr_hdl_)   &
    ...
    IMPLICIT NONE
      ...
      IF (PRESENT(chunking_weight_)) THEN
        CALL cxios_get_axisgroup_chunking_weight &
      (axisgroup_hdl%daddr, chunking_weight_)
      ENDIF
  ...
  SUBROUTINE xios(is_defined_axisgroup_attr_hdl_)   &
    ...
    IMPLICIT NONE
      ...
      IF (PRESENT(chunking_weight_)) THEN
        chunking_weight__tmp = cxios_is_defined_axisgroup_chunking_weight &
      (axisgroup_hdl%daddr)
