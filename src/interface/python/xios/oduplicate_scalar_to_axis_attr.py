...
class DuplicateScalarToAxis(Object): 
  _object_type = 'duplicate_scalar_to_axis'
  FIELD_META = {
  'duplicate_scalar_to_axis_id': {'type': String},
  }
...
DuplicateScalarToAxis._generate_child_methods()
