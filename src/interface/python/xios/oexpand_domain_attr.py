...
class ExpandDomain(Object): 
  _object_type = 'expand_domain'
  FIELD_META = {
  'expand_domain_id': {'type': String},
  'i_periodic': {'type': Bool},
  'j_periodic': {'type': Bool},
  'order': {'type': Int},
  'type': {'type': String},
  }
...
ExpandDomain._generate_child_methods()
