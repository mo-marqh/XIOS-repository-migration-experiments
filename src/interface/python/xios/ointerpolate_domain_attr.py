...
class InterpolateDomain(Object): 
  _object_type = 'interpolate_domain'
  FIELD_META = {
  'interpolate_domain_id': {'type': String},
  'detect_missing_value': {'type': Bool},
  'mode': {'type': String},
  'order': {'type': Int},
  'quantity': {'type': Bool},
  'read_write_convention': {'type': String},
  'renormalize': {'type': Bool},
  'use_area': {'type': Bool},
  'weight_filename': {'type': String},
  'write_weight': {'type': Bool},
  }
...
InterpolateDomain._generate_child_methods()
