...
class InterpolateAxis(Object): 
  _object_type = 'interpolate_axis'
  FIELD_META = {
  'interpolate_axis_id': {'type': String},
  'coordinate': {'type': String},
  'coordinate_dst': {'type': String},
  'coordinate_src': {'type': String},
...
InterpolateAxis._generate_child_methods()
