...
class ReorderDomain(Object): 
  _object_type = 'reorder_domain'
  FIELD_META = {
  'reorder_domain_id': {'type': String},
  'invert_lat': {'type': Bool},
  'max_lon': {'type': Double},
  'min_lon': {'type': Double},
  'shift_lon_fraction': {'type': Double},
  }
...
ReorderDomain._generate_child_methods()
