...
class ReduceDomainToScalar(Object): 
  _object_type = 'reduce_domain_to_scalar'
  FIELD_META = {
  'reduce_domain_to_scalar_id': {'type': String},
  'local': {'type': Bool},
...
ReduceDomainToScalar._generate_child_methods()
