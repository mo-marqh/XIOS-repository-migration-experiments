...
class ReduceScalarToScalar(Object): 
  _object_type = 'reduce_scalar_to_scalar'
  FIELD_META = {
  'reduce_scalar_to_scalar_id': {'type': String},
...
ReduceScalarToScalar._generate_child_methods()
