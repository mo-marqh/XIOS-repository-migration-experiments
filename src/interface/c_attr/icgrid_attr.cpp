...
extern "C"
{
  ...
  {
     CTimer::get("XIOS").resume();
    return !grid_hdl->axis_ref.isEmpty();
     CTimer::get("XIOS").suspend();
  }
  ...
  {
     CTimer::get("XIOS").resume();
    return !grid_hdl->description.isEmpty();
     CTimer::get("XIOS").suspend();
  }
  ...
  {
     CTimer::get("XIOS").resume();
    return !grid_hdl->domain_ref.isEmpty();
     CTimer::get("XIOS").suspend();
  }
