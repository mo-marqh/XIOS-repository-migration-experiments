...
//         virtual void fromBinary(StdIStream & is);
      ...
      // manage inherited id which is herited by reference
        void setInheritedId(T* obj) ;
        bool hasInheritedId(void) { return hasInheritedId_ ;}
        string getInheritedId(void) { return  inheritedId_ ;}

      private:  
         std::string inheritedId_ ;
         bool hasInheritedId_ = false;

      // manage the template id
      public:
         void setTemplateId(T* obj) ; //<! set the id of the object that served as template 
         bool hasTemplateId(void) {return hasTemplateId_;} //<! return  hasTemplateId_
         string getTemplateId(void)
         {
           if (hasTemplateId_) return templateId_  ;
           else if (hasId() && !hasAutoGeneratedId()) return getId() ;
           else if (hasInheritedId()) return getInheritedId() ;
           else return getId() ;
         }
      private:
