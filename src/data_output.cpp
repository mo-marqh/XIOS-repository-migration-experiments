...
namespace xios
{
      ...
      int CDataOutput::writeFieldData(CField* field, const CArray<double,1>& data, const CDate& lastWrite, const CDate& currentWrite, int nstep)
      TRY
      {
        return this->writeFieldData_(field, data, lastWrite, currentWrite, nstep);
      }
      CATCH
