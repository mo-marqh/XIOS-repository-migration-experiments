#ifndef __LEGACY_CONTEXT_SERVER_V2_HPP__
#define __LEGACY_CONTEXT_SERVER_V2_HPP__
...
namespace xios
{
  ...
  class CLegacyContextServerV2 : public CContextServer
  {
    public:

    CLegacyContextServerV2(CContext* parent,MPI_Comm intraComm,MPI_Comm interComm) ;
