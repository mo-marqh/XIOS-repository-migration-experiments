#ifndef __P2P_CONTEXT_CLIENT_HPP__
#define __P2P_CONTEXT_CLIENT_HPP__
...
namespace xios
{
  ...
  and processes them.
  */
  class CP2pContextClient : public CContextClient
  {
    public:
      // Contructor
      CP2pContextClient(CContext* parent, MPI_Comm intraComm, MPI_Comm interComm, CContext* parentServer = 0);
...
//      bool getBuffers(const size_t timeLine, const list<int>& serverList, const list<int>& sizeList, list<CBufferOut*>& retBuffers, bool nonBlocking = false);
      ...
      map<int,CP2pClientBuffer*> buffers_; //!< Buffers for connection to servers
