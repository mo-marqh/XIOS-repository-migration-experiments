...
MODULE IDOMAIN
   ...
   ( domaingroup_id, name, standard_name, long_name, domain_group_ref, ni_glo, nj_glo, ibegin, iend,       &
     ...
     zoom_ni, zoom_nj, zoom_ibegin, zoom_jbegin, zoom_ni_loc, zoom_nj_loc, zoom_ibegin_loc,                &
     zoom_jbegin_loc, data_n_index, data_i_index, data_j_index, lonvalue, latvalue)
      IMPLICIT NONE
